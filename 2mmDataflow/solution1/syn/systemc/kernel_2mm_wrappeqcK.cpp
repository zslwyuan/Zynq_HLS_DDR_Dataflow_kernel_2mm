...
void kernel_2mm_wrappeqcK::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void kernel_2mm_wrappeqcK::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void kernel_2mm_wrappeqcK::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void kernel_2mm_wrappeqcK::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
