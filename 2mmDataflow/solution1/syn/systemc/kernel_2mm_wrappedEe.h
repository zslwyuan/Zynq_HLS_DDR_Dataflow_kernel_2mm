...
#ifndef __kernel_2mm_wrappedEe__HH__
#define __kernel_2mm_wrappedEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_2mm_wrappedEe) {
    ...
    SC_CTOR(kernel_2mm_wrappedEe):  ACMP_mul_su_U ("ACMP_mul_su_U") {
