...
void kernel_2mm_wrappesc4::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void kernel_2mm_wrappesc4::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void kernel_2mm_wrappesc4::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void kernel_2mm_wrappesc4::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
