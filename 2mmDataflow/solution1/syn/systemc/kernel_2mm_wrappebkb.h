...
#ifndef __kernel_2mm_wrappebkb__HH__
#define __kernel_2mm_wrappebkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_2mm_wrappebkb) {
    ...
    SC_CTOR(kernel_2mm_wrappebkb):  ACMP_mul_su_U ("ACMP_mul_su_U") {
