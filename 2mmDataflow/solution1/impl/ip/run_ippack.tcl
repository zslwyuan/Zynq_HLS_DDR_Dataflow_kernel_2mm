...
set Library     "hls"
set IPName      "kernel_2mm_wrapper"
set Version     "1.0"
set DisplayName "Kernel_2mm_wrapper"
set Revision    "1909031101"
...
set Interfaces {
    s_axi_for_control {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_for_control"
        param_prefix "C_S_AXI_FOR_CONTROL"
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 A_AXI W 0x0 "Data signal of A_AXI" {{0 32 A_AXI W 0 "Bit 31 to 0 Data signal of A_AXI"}}} {0x18 B_AXI W 0x0 "Data signal of B_AXI" {{0 32 B_AXI W 0 "Bit 31 to 0 Data signal of B_AXI"}}} {0x20 C_AXI W 0x0 "Data signal of C_AXI" {{0 32 C_AXI W 0 "Bit 31 to 0 Data signal of C_AXI"}}} {0x28 D_input_AXI W 0x0 "Data signal of D_input_AXI" {{0 32 D_input_AXI W 0 "Bit 31 to 0 Data signal of D_input_AXI"}}} {0x30 D_output_AXI W 0x0 "Data signal of D_output_AXI" {{0 32 D_output_AXI W 0 "Bit 31 to 0 Data signal of D_output_AXI"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_for_control m_axi_gmem0 m_axi_gmem1 m_axi_gmem2 m_axi_gmem3 m_axi_gmem4"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem0 {
        ...
        has_dependant_on "1"
        offset_slave_name "s_axi_for_control"
...
## System Info
set user_parameters_list {clk_period 6 machine 64 combinational 0 latency 41564 II x}
