set C_TypeInfoList {{ 
"timer" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"reset_signal": [[],{ "pointer":  {"scalar": "int"}}] }, {"timeTicks": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
...
set C_modelArgList {
	{ reset_signal int 32 regular {axi_slave 0}  }
	{ timeTicks int 32 regular {axi_slave 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "reset_signal", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "reset_signal","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "timeTicks", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "timeTicks","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":24}, "offset_end" : {"out":31}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_BUS_A_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "BUS_A", "role": "AWADDR" },"address":[{"name":"timer","role":"start","value":"0","valid_bit":"0"},{"name":"timer","role":"continue","value":"0","valid_bit":"4"},{"name":"timer","role":"auto_start","value":"0","valid_bit":"7"},{"name":"reset_signal","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_BUS_A_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "BUS_A", "role": "ARADDR" },"address":[{"name":"timer","role":"start","value":"0","valid_bit":"0"},{"name":"timer","role":"done","value":"0","valid_bit":"1"},{"name":"timer","role":"idle","value":"0","valid_bit":"2"},{"name":"timer","role":"ready","value":"0","valid_bit":"3"},{"name":"timer","role":"auto_start","value":"0","valid_bit":"7"},{"name":"timeTicks","role":"data","value":"24"}, {"name":"timeTicks","role":"valid","value":"28","valid_bit":"0"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "reset_signal", "Type" : "None", "Direction" : "I"},
			{"Name" : "timeTicks", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "cnt", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.timer_BUS_A_s_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	timer {
		reset_signal {Type I LastRead 1 FirstWrite -1}
		timeTicks {Type O LastRead -1 FirstWrite 1}
