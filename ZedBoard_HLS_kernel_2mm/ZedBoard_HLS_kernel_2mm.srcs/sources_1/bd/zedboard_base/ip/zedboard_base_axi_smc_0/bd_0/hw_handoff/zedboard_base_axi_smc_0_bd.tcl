...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC010_ROUTE {0b00001} \
   CONFIG.SSC011_ROUTE {0b00010} \
   CONFIG.SSC012_ROUTE {0b00100} \
   CONFIG.SSC013_ROUTE {0b01000} \
   CONFIG.SSC014_ROUTE {0b10000} \
   CONFIG.SSC015_ROUTE {0b00000} \
