...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC003_ROUTE {0b00000} \
   CONFIG.SSC004_ROUTE {0b00000} \
   CONFIG.SSC005_ROUTE {0b00000} \
   CONFIG.SSC006_ROUTE {0b00000} \
   CONFIG.SSC007_ROUTE {0b00000} \
   CONFIG.SSC008_ROUTE {0b00000} \
   CONFIG.SSC009_ROUTE {0b00000} \
   CONFIG.SSC010_ROUTE {0b00000} \
   CONFIG.SSC011_ROUTE {0b00000} \
   CONFIG.SSC012_ROUTE {0b00000} \
   CONFIG.SSC013_ROUTE {0b00000} \
   CONFIG.SSC014_ROUTE {0b00000} \
   CONFIG.SSC015_ROUTE {0b00001} \
   CONFIG.SSC016_ROUTE {0b00010} \
   CONFIG.SSC017_ROUTE {0b00100} \
   CONFIG.SSC018_ROUTE {0b01000} \
   CONFIG.SSC019_ROUTE {0b10000} \
   CONFIG.SSC020_ROUTE {0b00000} \
   CONFIG.SSC021_ROUTE {0b00000} \
   CONFIG.SSC022_ROUTE {0b00000} \
   CONFIG.SSC023_ROUTE {0b00000} \
   CONFIG.SSC024_ROUTE {0b00000} \
   CONFIG.SSC025_ROUTE {0b00000} \
   CONFIG.SSC026_ROUTE {0b00000} \
   CONFIG.SSC027_ROUTE {0b00000} \
   CONFIG.SSC028_ROUTE {0b00000} \
   CONFIG.SSC029_ROUTE {0b00000} \
   CONFIG.SSC030_ROUTE {0b00000} \
   CONFIG.SSC031_ROUTE {0b00000} \
