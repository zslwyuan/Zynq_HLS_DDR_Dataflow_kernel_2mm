...
HD_PWD='/home/tingyuan/Documents/ddr_check/zedboard-base-master/zedboard_base.xpr/zedboard_base/zedboard_base.runs/zedboard_base_processing_system7_0_0_synth_1'
cd "$HD_PWD"
