...
HD_PWD='/home/tingyuan/Documents/ddr_check/zedboard-base-master/zedboard_base.xpr/zedboard_base/zedboard_base.runs/zedboard_base_timer_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_base_timer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedboard_base_timer_0_1.tcl
