...
HD_PWD='/home/tingyuan/Documents/ddr_check/zedboard-base-master/zedboard_base.xpr/zedboard_base/zedboard_base.runs/zedboard_base_kernel_2mm_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_base_kernel_2mm_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedboard_base_kernel_2mm_wrapper_0_0.tcl
